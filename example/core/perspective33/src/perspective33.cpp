...
public:
    ...
    void InitializeGL()
    {
        ...
        mShader0->Set<core::CPerspective>(core::Perspective, 90.0f, 1.0, 0.1f, 100.0f);
        mShader0->Apply();
        ...
        mShader1->Set<core::CPerspective>(core::Perspective, 90.0f, 1.0, 0.1f, 100.0f);
        mShader1->Apply();
        ...
        mRect->Set<core::CTexture>(core::Texture, RIM0.GetRaw<GLfloat>(), RIM0.GetSize(), bmp->Width, bmp->Height, bmp->DataOffset, bmp->Bits_Per_Pixel);
        mRect->Set(mShader0);
        mRect->Apply();
    ...
    {
        mRect->Set<core::CPerspective>(core::Perspective, 30.0f, 2.0, 0.1f, 100.0f);
        mRect->Update();

        // mObject->Set<core::CPerspective>(core::Perspective, 45.0f, SCR_WIDTH / SCR_HEIGHT, 0.1f, 100.0f);
        // mObject->Update();
    }
